# from https://gist.github.com/johnmeade/d8d2c67b87cda95cd253f55c21387e75
...
def wada_snr(wav):
    ...
    # print(wav.shape, max(wav), min(wav))
    # init
    eps = 1e-10
